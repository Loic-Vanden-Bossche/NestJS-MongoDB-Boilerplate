...
const getConfigDoc = <T>(dto: ClassConstructor<T>, configDefault: T): ConfigLine[] => {
...
const triggerConfigDocGen = <T>(configDto: ClassConstructor<T>, configDefault: T, subTitle: string , docFile: string = 'CONFIG.md', fileWatchDir: string = './config') => {
